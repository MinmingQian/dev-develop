...
<head>
  ...
  <!-- 导航栏 -->
  <div id="wrapper">
    <nav class="navbar navbar-inverse navbar-fixed-top home-nav" style="background-color:#B9374A !important;border: none;">
      <div style="padding-left: 10%;padding-right: 10%;">
        <div class="navbar-header">
          ...
          <a class="navbar-brand home-brand" href="/">LOGO</a>
        </div>
        <div id="navbar" class="navbar-collapse collapse" style="padding-left: 15%; font-size: 18px">
          <ul class="nav navbar-nav">
            <li><a href="{{url('/')}}" class="home-collapse-item">首页</a></li>

            <li><a href="{{url('/search')}}" class="home-collapse-item">找租房</a></li>

            <li><a href="{{url('/holder')}}" class="home-collapse-item">业主加盟</a></li>

            <li><a href="{{url('/about')}}" class="home-collapse-item">关于心有居</a></li>          <!-- here should be the flickr address -->
          </ul>

          <ul class="nav navbar-nav navbar-right">
            @if (Auth::guest())
              <li><a href="{{ url('/auth/login') }}" class="home-log-btn">登录</a></li>
              <li><a href="{{ url('/auth/register') }}" class="home-reg-btn">注册</a></li>
            @else
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">{{ Auth::user()->name }} <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="{{ url('/apartments/add') }}">申请添加房源</a></li>
  ...
  @yield('content')
      ...
      <!-- 页脚 -->
    <div class="container-fluid col-sm-12" style="padding-top: 2%;padding-bottom: 2%; background-color:#404247; ">
      ...
      <div class="row" style="text-align: center;margin-top: 1.5%;margin-bottom: 1.5%;">
        <button type="button" class="btn btn-default home-foot-button" style="border-radius: 0 !important; color: white;">在线客服</button>
      </div>
