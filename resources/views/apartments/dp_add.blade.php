...
@section('content' )
      ...
      <div class="tabbable tabs-left" style="width: 100%; padding-top: 53px;">

          <div class="col-sm-12" style="padding: 0px;">
                  <div class="col-sm-2" style="padding: 0px;background-color: #F5F5F5;overflow: scroll;height: 100vh;" >
                                  <ul class="nav tab-sub">
                                    <li class="active"><a href="#houseinfo" data-toggle="tab">房屋描述</a></li>
                                    <li><a href="#roominfo" data-toggle="tab">房间描述</a></li>
                                  </ul>
                  </div>
                  ...
                  {!! Form::open(array('url' => 'apartments/submit','method'=>'post','files' => true)) !!}
                          <div class="tab-content addstyle" style="padding: 5vh;">
                           ...
                           <div class="col-md-12">
                             <a class="btn btn-primary add-more" onclick="add()">添加房间</a>
                               <hr>
                           </div>
                            ...
                            <div class="col-sm-12" style="margin-bottom: 5%;">
                             <div class="col-sm-6">
                                <a class="btn btn-info btnPrevious" style="float:left;">上一页</a>
                             </div>
                            <div class="col-sm-6">
